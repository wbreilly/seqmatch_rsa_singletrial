...
userOptions.analysisName = 'seqmatch_betweenrun_FSrois_sameposition_11_28_18';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = '/Users/wbr/walter/fmri/seqmatch/ROIs/freesurfer_wbr/[[subjectName]]/corticalroi/[[maskName]]';
...
%%
%            % FS and ANTS ROIs
            userOptions.maskNames = {'lh_occ'; 'rh_occ'};
