...
% analysis name
analysis = 'DVSS_samepos_3_6_18';
% you know who
subjects = {'s001' 's002' 's003' 's004' 's007' 's008' 's009' 's010' 's011' 's015' 's016' 's018' 's019' 's020' 's022' 's023' 's024' 's025'}; 
% load the RSA matrices     
load('/Users/wbr/walter/fmri/sms_scan_analyses/rsa_singletrial/singletrial_4_rsatoolbox/RDMs/FS_ANTS_samepos_3_1_18_RDMs.mat');
% load mask
...
for imask = 1:15
    ...
    for iRDM = 1:size(RDMs,2)
        ...
        beta_txt = fullfile(bad_beta_path,subjects{iRDM}, 'beta_4_rsa_singletrial', '1.15_bad_fullsample_3_3_18.txt');
