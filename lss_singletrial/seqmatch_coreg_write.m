...
for i = 2:length(subjects)
    ...
    for irun = 1:length(b.runs)
        ...
        if runflag
            ...
            % of each run
            b.funcDir = fullfile(b.dataDir, runs{1},'reg');
            ...
            matlabbatch{1}.spm.spatial.coreg.write.ref = cellstr(b.examplefunc);
            matlabbatch{1}.spm.spatial.coreg.write.source = cellstr(b.files);
